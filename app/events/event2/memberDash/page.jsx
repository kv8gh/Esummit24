        ...
        <div className="flex flex-wrap justify-center">
          {
            teamMembersData.map(el=>{
              return <Card name={el.name} key={el.name} regNo={el.regNo} Role={el.event2TeamRole===0?'Leader':'Member'} leader={false} phone={el.mobNo} imageSrc={boardImg} />
            })
          }
        </div>
      </div>
