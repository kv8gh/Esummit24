...
export async function GET(req, res) {
  ...
  const teamId = Event1Test.findById({_id:userId });
  console.log('vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv',teamId);
  const qualTeam = await Round0.findById({ teamId: userId });
  console.log('nnnnnnnnnnnnnnnnnnnn',qualTeam);
