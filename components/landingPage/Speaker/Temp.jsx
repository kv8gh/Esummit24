...
const Temp = () => {
  return (
    <section id="speakers" class="sm:px-5 md:px-20 w-full flex bg-[#0E0E0E] flex-col items-center justify-center">
      ...
      <div class="min-h-72 w-4/5 flex items-center justify-center rounded-lg bg-gradient-to-b from-[#ffffff00] via-[#fefab730] to-[#d69a3f20] p-1 border-2 border-[#D6993F] m-12">
